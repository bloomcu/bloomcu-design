...
const colorPrimary = ref('purple')
const colorAccent = ref('red')
const colorContrastHigh = ref('brown')
const colorContrastHigher = ref('blue')
const colorBackground = ref('tan')
</script>
