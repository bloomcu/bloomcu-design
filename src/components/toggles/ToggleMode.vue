<template>
  <ul class="radio-switch-vertical">
    <li @click="toggleEditMode()" class="radio-switch-vertical__item">
      <input class="radio-switch-vertical__input sr-only" type="radio" name="radio-switch-vertical-name" id="radio-1" :checked="store.mode === 'edit'">
    ...
    <li @click="toggleViewMode()" class="radio-switch-vertical__item">
      <input class="radio-switch-vertical__input sr-only" type="radio" name="radio-switch-vertical-name" id="radio-2" :checked="store.mode === 'view'">
